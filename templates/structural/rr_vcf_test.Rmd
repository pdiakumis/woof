...
read_svs <- function(fname) {
  ...
  DF <- 
    readr::read_tsv(
      file = "~/Desktop/tmp/E019-manta_svs.tsv",
      na = c(".", "", "NA"),
...
#---- Facets ----#
facets_fit <- "~/Desktop/projects/umccr/A5/batch1/E019/E019_cval_150_fit.rds"
...
circos(R = 260, cir = db, type = "arc", W = 120, mapping = mapdat, col.v = 4, B = TRUE, cutoff = 2, lwd = 4, col = mapdat$col, scale = TRUE, cex = 10)

circos(R = 260, cir = db, type = "link", W = 40, mapping = svs[svs$svtype == "BND", ], lwd = 2, col = "grey")
circos(R = 260, cir = db, type = "link2", W = 20, mapping = linkdat_samechrom, lwd = 1, col = c("darkblue", "green")[ifelse(linkdat_samechrom$type == "del", 1, 2)])
dev.off()
```
